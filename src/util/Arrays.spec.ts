...
describe(module.id, () => {
    describe("Arrays.init()", () => {
        it("should Arrays.initialize a proper array", () => {
        ...
        it("should work in the empty case", () => {
            const a1 = Arrays.init(0, (i) => i);
            expect(a1).toBeTruthy();
            expect(a1.length).toBe(0);
        });

        it("should work in the negative case", () => {
            const a1 = Arrays.init(-500, (i) => i);
            expect(a1).toBeTruthy();
            expect(a1.length).toBe(0);
        });

        it("should work in the NaN case", () => {
            const a1 = Arrays.init(NaN, (i) => i);
            expect(a1).toBeTruthy();
            expect(a1.length).toBe(0);
        });

        it("should work in the InfArrays.inity cases", () => {
    ...
    describe("Arrays.zipTruncated()", () => {
        it("should zip equal sized arrays", () => {
        ...
        it("should truncate unequal arrays", () => {
            const a1 = Arrays.init(5, (i) => i * i);
    ...
    describe("Arrays.zip()", () => {
        ...
        it("should place undefined in nonexistent elements for unequal arrays", () => {
            const a1 = Arrays.init(5, (i) => i * i);
            const a2 = Arrays.init(10, (i) => i);
            const a3 = Arrays.zip(a1, a2);
            expect(a3.length).toBe(10);
            expect(a3[0].length).toBe(2);
            expect(a3).toEqual(Arrays.init(10, (i) => [i < 5 ? i * i : undefined, i]));
        }); 
    });
});